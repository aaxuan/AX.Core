...
namespace AX.Core.Network
{
    public class Mail
    {
        public static Mail MailManager { get; set; }

        public Encoding Encoding { get; set; } = GlobalDefaultSetting.Encoding;
        ...
        public void BatchSend(List<string> toAddress, string body, string subject = null)
        {
            ...
            { subject = $"{Process.GetCurrentProcess().ProcessName} 系统通知"; }
